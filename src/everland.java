...
Scanner myInput = new Scanner(System.in);
		...
		char ticketNum =' ';			// 날짜 별 A,B,C 티켓 구분
		int price =0;
		String udae = null;				// 우대 정보
		int age =0;
		...
		int todayYear = Integer.parseInt(todayDate.substring(0,4));
		int todayMD = Integer.parseInt(todayDate.substring(4));
		...
		while(true) {
			...
			if (ticketNum=='A' || ticketNum=='B' || ticketNum=='C' ) {
				...
				System.out.printf("%s티켓  %s x %d\t%d원\t   *%s",
